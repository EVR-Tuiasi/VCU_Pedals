...
#include "Can_43_FLEXCAN_Externals.h"
    ...
    #include "Stm_Ip.h"
#endif
#ifdef CAN_43_FLEXCAN_TS_STIMER_USED
    #include "Stimer_Ip.h"
#endif
...
#define CAN_43_FLEXCAN_IPW_AR_RELEASE_MINOR_VERSION_C     9
#define CAN_43_FLEXCAN_IPW_AR_RELEASE_REVISION_VERSION_C  0
#define CAN_43_FLEXCAN_IPW_SW_MAJOR_VERSION_C             7
#define CAN_43_FLEXCAN_IPW_SW_MINOR_VERSION_C             0
#define CAN_43_FLEXCAN_IPW_SW_PATCH_VERSION_C             1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
#define CAN_IPW_EXTENDED_ID_FILTER_MASK                     ((uint32)0x20000000U) /* bit 29 is used as masking for standard/extended type of each filter element when the ID type is MIXED. */
...
/**
*   @brief      Store current state of each Controller
*/
static Flexcan_Ip_StateType Can_Ipw_apxStatus[CAN_43_FLEXCAN_CONTROLLER_CONFIG_COUNT];
    ...
    */
    ...
    /**
    * @brief     Store current clock mode of each Controller
    */
...
#if ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON) && (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON))
#if (CAN_43_FLEXCAN_NO_CACHE_NEEDED == STD_ON)
#define CAN_43_FLEXCAN_START_SEC_VAR_CLEARED_32_NO_CACHEABLE
#else
#define CAN_43_FLEXCAN_START_SEC_VAR_CLEARED_32
...
static uint32 Can_Ipw_u32MbTransferredIndex[CAN_43_FLEXCAN_CONTROLLER_CONFIG_COUNT];
...
#endif /* (CAN_43_FLEXCAN_NO_CACHE_NEEDED == STD_ON) */
#include "Can_43_FLEXCAN_MemMap.h"
#endif /* ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON) && (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)) */
...
static void Can_Ipw_InitRxMsgBuffer(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject);

static void Can_Ipw_SetLegacyFifoFilterMaskFormatA(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject, uint8 u8FilterElementCount);

static void Can_Ipw_SetLegacyFifoFilterMaskFormatB(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject, uint8 u8FilterElementCount);

static void Can_Ipw_SetLegacyFifoFilterMaskFormatC(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject, uint8 u8FilterElementCount);

static void Can_Ipw_InitRxLegacyFifo(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject);

static Flexcan_Ip_StatusType Can_Ipw_TransferData
(
    const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
    const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObjectConfig,
    uint8 u8HwBufferIndex,
    const Can_PduType * PduInfo,
    Flexcan_Ip_DataInfoType * DataInfo
);

#if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
    static void Can_Ipw_InitRxEnhancedFifo(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject);
#endif /* CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON */
...
/* Init all Rx objects */
static void Can_Ipw_InitReceiveHwObject(const Can_43_FLEXCAN_ControllerConfigType * Can_pController);
...
static void Can_Ipw_GetTimestamp(Can_TimeStampType * TimestampPtr, uint32 Value);
    ...
    (
        ...
        static void Can_43_FLEXCAN_Ipw_ProcessRxEnhance
        (
            const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
            const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObjectConfig,
            uint8 u8Event
        ...
        /* Process Rx Enhance FIFO Dma */
        static void Can_43_FLEXCAN_Ipw_ProcessRxEnhanceDma
        (
            const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
            const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObjectConfig,
            uint8 u8Event
        ...
        /* Process Rx Legacy FIFO Interrupt */
        static void Can_43_FLEXCAN_Ipw_ProcessRxLegacy
        (
            const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
            const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObjectConfig,
            uint8 u8MbIdx
        ...
        /* Process to Map MB index to hardware object ID */
        static void Can_43_FLEXCAN_Ipw_HandleMapMbIndxToObjID
        (
            const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig
        );

    #if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
        /* Process Rx Legacy FIFO Dma */
    ...
    /* Start all receive object which using interrupt or Dma */
    static void Can_Ipw_StartAsyncReceiveObject(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig);
...
)
{
    ...
    */
    ...
    if (CAN_43_FLEXCAN_RX_NORMAL == Can_pHwObjectConfig->Can_eReceiveType)
    {
        /* Check if Mb Overrun */
    ...
    if (CAN_43_FLEXCAN_RX_LEGACY_FIFO != Can_pHwObjectConfig->Can_eReceiveType)
    {
        /*
...
#if (CAN_43_FLEXCAN_LPDU_HRH_EXTEND_SUPPORT == STD_ON)
    if (TRUE == CAN_43_FLEXCAN_LPDU_CALLOUT_FUNC_CALLED((uint16)Can_pHwObjectConfig->Can_HwObjectID, \
                                                      CanIf_Mailbox->CanId, \
                                                      (uint8)CanIf_PduInfo->SduLength, \
...
#endif /* (CAN_43_FLEXCAN_LPDU_HRH_EXTEND_SUPPORT == STD_ON) */
    {
#endif /* (CAN_43_FLEXCAN_LPDU_CALLOUT_SUPPORT == STD_ON) */
...
static void Can_Ipw_InitRxMsgBuffer(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject)
{
    ...
    for (u8ObjIdx = 0U; u8ObjIdx < Can_pHwObject->Can_u8ObjectCount; u8ObjIdx++)
    {
        ...
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[u8ObjIdx].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
            DataInfo.msg_id_type = FLEXCAN_MSG_ID_EXT;
        }
        else if ((CAN_43_FLEXCAN_STANDARD == Can_pHwObject->Can_IdMessage) || \
                 (0U == (Can_pHwObject->Can_pHwFilterConfig[u8ObjIdx].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
        ...
        (void)FlexCAN_Ip_ConfigRxMb(Can_pController->Can_u8ControllerOffset, (Can_pHwObject->Can_pHwBufferIndex)[u8ObjIdx], &DataInfo, (Can_pHwObject->Can_pHwFilterConfig[u8ObjIdx].Can_u32HwFilterCode & 0x1FFFFFFFU));
        /* Already in freeze mode */
        (void)FlexCAN_Ip_SetRxIndividualMask(Can_pController->Can_u8ControllerOffset, (Can_pHwObject->Can_pHwBufferIndex)[u8ObjIdx], Can_pHwObject->Can_pHwFilterConfig[u8ObjIdx].Can_u32HwFilterMask);
    }
}
...
static void Can_Ipw_SetLegacyFifoFilterMaskFormatA(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject, uint8 u8FilterElementCount)
{
    ...
    uint32 u32HwFilterMask = (uint32)0xC0000000U;

    for (u8FilterIdx=0U; u8FilterIdx < u8FilterElementCount; u8FilterIdx++)
    {
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
        ...
        else /* For STANDARD or MIXED with standard type */
        {
...
{
    uint8 u8FilterIdx = 0U;
    uint32 u32HwFilterMask = (uint32)0xC000C000U;

    for (u8FilterIdx=0U; u8FilterIdx < u8FilterElementCount; u8FilterIdx++)
    {
        /* RXIDB_0 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[u8FilterIdx * 2U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
        ...
        /* RXIDB_1 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[(u8FilterIdx * 2U) + 1U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
...
static void Can_Ipw_SetLegacyFifoFilterMaskFormatC(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject, uint8 u8FilterElementCount)
{
    ...
    for (u8FilterIdx=0U; u8FilterIdx < u8FilterElementCount; u8FilterIdx++)
    {
        /* RXIDC_0 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[u8FilterIdx * 4U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
        ...
        /* RXIDC_1 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[(u8FilterIdx * 4U) + 1U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
        ...
        /* RXIDC_2 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[(u8FilterIdx * 4U) + 2U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
        ...
        /* RXIDC_3 */
        if ((CAN_43_FLEXCAN_EXTENDED == Can_pHwObject->Can_IdMessage) || \
            (CAN_IPW_EXTENDED_ID_FILTER_MASK == (Can_pHwObject->Can_pHwFilterConfig[(u8FilterIdx * 4U) + 3U].Can_u32HwFilterCode & CAN_IPW_EXTENDED_ID_FILTER_MASK)))
        {
...
static void Can_Ipw_InitRxLegacyFifo(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject)
{
    ...
    /* The possible number of Legacy Fifo filter element affected by Rx individual masks */
    ...
    if (CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_A == Can_pController->Can_eLegacyAcceptanceMode)
    {
        u16HwFilterCount =  Can_pHwObject->Can_u8HwFilterCount;
        eElementFormat = FLEXCAN_RX_FIFO_ID_FORMAT_A;
        Can_Ipw_SetLegacyFifoFilterMaskFormatA(Can_pController, Can_pHwObject, u8FiFoFilterIndvCount);
    }
    else if (CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_B == Can_pController->Can_eLegacyAcceptanceMode)
    {
        u16HwFilterCount = ((uint16)Can_pHwObject->Can_u8HwFilterCount * (uint16)2U);
        eElementFormat = FLEXCAN_RX_FIFO_ID_FORMAT_B;
        Can_Ipw_SetLegacyFifoFilterMaskFormatB(Can_pController, Can_pHwObject, u8FiFoFilterIndvCount);
    }
    else /* CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_C == Can_pController->Can_eLegacyAcceptanceMode */
    {
        u16HwFilterCount = ((uint16)Can_pHwObject->Can_u8HwFilterCount * (uint16)4U);
        eElementFormat = FLEXCAN_RX_FIFO_ID_FORMAT_C;
        Can_Ipw_SetLegacyFifoFilterMaskFormatC(Can_pController, Can_pHwObject, u8FiFoFilterIndvCount);
    }
    (void)FlexCAN_Ip_SetRxFifoGlobalMask(Can_pController->Can_u8ControllerOffset, Can_pController->Can_u32LegacyGlobalMask);

    if (u16HwFilterCount != 0U)
    {
        for (u8FilterIdx = 0U; (uint16)u8FilterIdx < u16HwFilterCount; u8FilterIdx++)
        {
            RxFifoFilters[u8FilterIdx].id = Can_pHwObject->Can_pHwFilterConfig[u8FilterIdx].Can_u32HwFilterCode;
            if (CAN_43_FLEXCAN_STANDARD != Can_pHwObject->Can_IdMessage)
            {
                RxFifoFilters[u8FilterIdx].isExtendedFrame = TRUE;
            }
            else /* For STANDARD type */
            {
...
)
{
    ...
    if ((TRUE == Can_pHwObjectConfig->Can_bTriggerTransmit) &&  (NULL_PTR == PduInfo->sdu))
    {
        ...
        {
            /* CanIf_PduInfo.SduLength shall be updated with the actual payload length within CanIf_TriggerTransmit function. It's required the value can't be greater than 64 bytes.
               The check is intended to prevent the casting violation from uint32 to uint8 */
            if (CanIf_PduInfo.SduLength <= (PduLengthType)64U)
            {
                DataInfo->data_length = (uint8)CanIf_PduInfo.SduLength;
            }
            eRetVal = FlexCAN_Ip_Send(Can_pControllerConfig->Can_u8ControllerOffset,
                                      u8HwBufferIndex,
                                      DataInfo,
                                      PduInfo->id,
                                      Data
...
#endif /* (CAN_43_FLEXCAN_TRIGGER_TRANSMIT_USED == STD_ON) */
    {
    ...
    static void Can_Ipw_InitRxEnhancedFifo(const Can_43_FLEXCAN_ControllerConfigType * Can_pController, const Can_43_FLEXCAN_HwObjectConfigType * Can_pHwObject)
    {
        ...
        if ((Can_pHwObject->Can_u8HwFilterCount) != 0U)
        {
            ...
            (void)FlexCAN_Ip_ConfigEnhancedRxFifo(Can_pController->Can_u8ControllerOffset, RxFifoFiltersEnhanced);
        }
    }
#endif
...
)
{
    ...
    while ((u8ObjIdx < Can_pHwObjectConfig->Can_u8ObjectCount) && (TRUE == returnResult))
    {
        ...
        /* Reset state of legacy fifo mapped to current HwObject before start new reception */
        Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[CAN_43_FLEXCAN_MB_LEGACY_RXFIFO].state = FLEXCAN_MB_IDLE;

        (void)FlexCAN_Ip_RxFifo(Can_pControllerConfig->Can_u8ControllerOffset, pReceivedDataBuffer);
        FlexCAN_Ip_MainFunctionRead(Can_pControllerConfig->Can_u8ControllerOffset, *(Can_pHwObjectConfig->Can_pHwBufferIndex));

        if (FLEXCAN_STATUS_SUCCESS == FlexCAN_Ip_GetTransferStatus(Can_pControllerConfig->Can_u8ControllerOffset, *(Can_pHwObjectConfig->Can_pHwBufferIndex)))
        {
...
)
{
    ...
    while (u8ObjIdx < Can_pHwObjectConfig->Can_u8ObjectCount)
    {
        ...
        if (TRUE == FlexCAN_Ip_GetBuffStatusFlag(Can_pControllerConfig->Can_u8ControllerOffset, CAN_43_FLEXCAN_MB_ENHANCED_RXFIFO))
        {
            (void)Det_ReportRuntimeError((uint16)CAN_43_FLEXCAN_IPW_MODULE_ID, (uint8)CAN_43_FLEXCAN_INSTANCE, (uint8)CAN_43_FLEXCAN_SID_MAIN_FUNCTION_READ, (uint8)CAN_43_FLEXCAN_E_DATALOST);
            ...
            FlexCAN_Ip_ClearBuffStatusFlag(Can_pControllerConfig->Can_u8ControllerOffset, CAN_43_FLEXCAN_MB_ENHANCED_RXFIFO);
        }

        /* Reset state of enhanced fifo mapped to current HwObject before start new reception */
        Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].enhancedFifoOutput.state = FLEXCAN_MB_IDLE;

        (void)FlexCAN_Ip_RxFifo(Can_pControllerConfig->Can_u8ControllerOffset, pReceivedDataBuffer);
        FlexCAN_Ip_MainFunctionRead(Can_pControllerConfig->Can_u8ControllerOffset, CAN_43_FLEXCAN_MB_ENHANCED_RXFIFO);

        if (FLEXCAN_STATUS_SUCCESS == FlexCAN_Ip_GetTransferStatus(Can_pControllerConfig->Can_u8ControllerOffset, CAN_43_FLEXCAN_MB_ENHANCED_RXFIFO))
        {
            Can_Ipw_ParseData(CanIf_Mailbox, \
                              CanIf_PduInfo, \
                              pReceivedDataBuffer, \
...
static uint32 Can_Ipw_GetTimeElapsed(uint32 counterValue, uint32 compareValue)
{
    ...
    /* Calculate the elapsed time within timestamp captured and current compare value */
    if (counterValue > compareValue)
    {
        DiffValue = ((CAN_IPW_STM_MAXCOUNTER_VALUE - counterValue) + compareValue) + 1U;
    }
    else
    {
        DiffValue = compareValue - counterValue;
    }

    if (DiffValue > CAN_43_FLEXCAN_TS_STM_TARGETTIME)
    {
        /* mark as the timestamp captured was not in current compare period */
        TimeElapsed = CAN_43_FLEXCAN_TS_STM_TARGETTIME + (uint32)1U;
    }
    else
    {
        /* the timestamp captured was in current compare period. calculating the time elapsed from previous compare to captured point */
        TimeElapsed = CAN_43_FLEXCAN_TS_STM_TARGETTIME - DiffValue;
    }
...
#ifdef CAN_43_FLEXCAN_TS_STIMER_USED
    uint32 u32TimerCurTimeHigh;
    uint32 u32TimerCurTimeLow;
    uint64 u64TimerCurTime;

    u64TimerCurTime     = Stimer_Ip_GetTimerCounterVal(CAN_43_FLEXCAN_TS_STIMER_INSTANCE);
    u32TimerCurTimeHigh = (uint32)(u64TimerCurTime >> 32U);
    u32TimerCurTimeLow  = (uint32)(u64TimerCurTime & (uint64)0xFFFFFFFFU);
    /*
    * Case need to be considered:
    * - 32bit counter low is overflowed at first time and current 32bit counter low value captured by driver is grater than the value captured by FlexCAN at the moment frame received.
    * - 32bit counter low is overflowed more times and current 32bit counter low value captured by driver is less or grater than the value captured by FlexCAN at the moment frame received.
    * => These cases are unexpected to happend.
    */
    /* This is to cover 32bit counter low is overflowed at first time and current 32bit counter low value captured by driver is less than the value captured by FlexCAN at the moment frame received. */
    if ((u32TimerCurTimeLow < Value) && (u32TimerCurTimeHigh > 0U))
    {
        u32TimerCurTimeHigh--;
    }
    u64TimerCurTime = (uint64)((uint64)u32TimerCurTimeHigh << 32U) | (uint64)Value;
    /* Calculate second part */
    TimestampPtr->seconds = (uint32)((u64TimerCurTime / (uint64)CAN_43_FLEXCAN_TS_STIMER_TICK_PER_SECOND) & (uint64)UINT32_MAX);
    /* Calculate nanosecond part */
    TimestampPtr->nanoseconds = (uint32)(((u64TimerCurTime % (uint64)CAN_43_FLEXCAN_TS_STIMER_TICK_PER_SECOND) * CAN_43_FLEXCAN_TS_STIMER_ACCURACY) / (uint64)1000UL);
#endif

#ifdef CAN_43_FLEXCAN_TS_STM_USED
/*
* The timer counter is increasing to boundary:
*              PreCompare|            CurrCompare|
*                        |                       |
*  |==========X==========|-|==========X==========|-|==========X==========|-|=====================|-|========> MaxCounter
*            [1]         [2]         [3]         [4]         [5]
*
*
* The timer counter is overflow:
*     CurrCompare|                                                                     PreCompare|
*                |                                                                               |
*  |=====X=======|-|==========X==========|-|.............................|-|==========X==========|-|====X===> MaxCounter
*       [3]      [4]         [5]                                                     [1]         [2]   [3]
*
...
*
* Note:
*     PreCompare to CurrCompare is the current period of time base. It's 1s duration
*     [1], [2], [3], [4], [5] are possible timestamp captured by FlexCAN
*     |-| is the duration for STM's interrupt execution
*/
    uint32 CurrCompare = 0U;
    uint32 PreCompare = 0U;
    uint32 CurrCompareTemp = 0U;
    uint32 TimeElapsed = 0U;

    CurrCompare = Can_Ipw_u32CurrentCompareVal;
    PreCompare = Can_Ipw_u32PreviousCompareVal;
    CurrCompareTemp = Stm_Ip_GetCompareValue(CAN_43_FLEXCAN_TS_STM_INSTANCE, CAN_43_FLEXCAN_TS_STM_CHANNEL);

    if (CurrCompareTemp != CurrCompare)
    {
        PreCompare = CurrCompare;
        CurrCompare = CurrCompareTemp;
    }

    /* Get second part */
    TimestampPtr->seconds = Can_Ipw_u32Seconds;
    /* Get time elapsed */
    TimeElapsed = Can_Ipw_GetTimeElapsed(Value, CurrCompare);

    /* The timestamp was not captured in current period */
    if (TimeElapsed > CAN_43_FLEXCAN_TS_STM_TARGETTIME)
    {
        /* Case [5]: timestamp captured > compare value can happen if have many pending frames while driver was processing inside CAN's interrupt
         * stm interrupt can not be handled during CAN interrupt processing
        */
        if (((Value > CurrCompare) && ((Value - CurrCompare) < CAN_43_FLEXCAN_TS_STM_TARGETTIME)) || \
            ((Value < PreCompare) && ((PreCompare - Value) > CAN_43_FLEXCAN_TS_STM_TARGETTIME)))
        {
            TimestampPtr->nanoseconds = 0U;
            if (TimestampPtr->seconds < (uint32)UINT32_MAX)
            {
                (TimestampPtr->seconds)++;
            }
            else
            {
                /* If seconds would overflow, saturate at maximum value */
                TimestampPtr->seconds = (uint32)UINT32_MAX;
            }
        }
        else
        {
            TimeElapsed = Can_Ipw_GetTimeElapsed(Value, PreCompare);
            ...
            if (TimeElapsed >= CAN_43_FLEXCAN_TS_STM_TARGETTIME)
            {
                ...
                it means that CurrCompare - PreCompare > CAN_43_FLEXCAN_TS_STM_TARGETTIME because it depends on stm's performence for processing its ISR, Then if a flexcan timestamp was captured in that time, the nanosecond will be 0 */
                /* Example:
                *          10s                          11s
                *-|---------------------|-----|----------------------|---------------------------->
            ...
            {
                /* Case [1]: The timestamp was captured within previous period */
                TimestampPtr->nanoseconds = (uint32)(((uint64)TimeElapsed * (uint64)CAN_43_FLEXCAN_TS_ACCURACY) / (uint64)1000UL);
                ...
                {
                    /* If seconds would underflow, saturate at minimum value */
                    TimestampPtr->seconds = 0U;
                }
            }
        }
    }
    /* Case [4]: The flexcan's ts captured at compare value but the flexcan's isr processed prior to stm isr */
    else if (TimeElapsed == CAN_43_FLEXCAN_TS_STM_TARGETTIME)
    {
        TimestampPtr->nanoseconds = 0U;
        if (TimestampPtr->seconds < (uint32)UINT32_MAX)
        {
    ...
    {
        /* Case [3]: The timestamp was captured in current period */
        TimestampPtr->nanoseconds = (uint32)(((uint64)TimeElapsed * (uint64)CAN_43_FLEXCAN_TS_ACCURACY) / (uint64)1000UL);
    }
#endif /* CAN_43_FLEXCAN_TS_STM_USED */
}
...
{
    if (Can_Ipw_u32Seconds < (uint32)UINT32_MAX)
    {
        Can_Ipw_u32Seconds++;
    }
    else
    {
        /* Saturate seconds at maximum value if it would overflow */
        Can_Ipw_u32Seconds = (uint32)UINT32_MAX;
    }
    ...
    */
    ...
    )
    {
        ...
        {
            if (CAN_43_FLEXCAN_TX_NORMAL == Can_pHwObjectConfig[u8HwObjectID].Can_eReceiveType)
            {
    ...
    */
    ...
    )
    {
        ...
        if ((CAN_43_FLEXCAN_HWOBJ_UNMAPPED != u8HwObjectID) && (FALSE == Can_pHwObjectConfig[u8HwObjectID].Can_bHwObjectUsesPolling))
        {
            ...
            pReceivedDataBuffer = Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[u8MbIdx].pMBmessage;
            Can_Ipw_ParseData(&CanIf_Mailbox, \
                                &CanIf_PduInfo, \
                                pReceivedDataBuffer, \
                                Can_pControllerConfig, \
    ...
    /**
    *   @brief     Process Rx Legacy FIFO Interrupt
    */
    static void Can_43_FLEXCAN_Ipw_ProcessRxLegacy
    (
        const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
    ...
    )
    {
        ...
        if ((CAN_43_FLEXCAN_HWOBJ_UNMAPPED != u8HwObjectID) && (FALSE == Can_pHwObjectConfig[u8HwObjectID].Can_bHwObjectUsesPolling))
        {
            ...
            {
                pReceivedDataBuffer = Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[*(Can_pHwObject->Can_pHwBufferIndex)].pMBmessage;
                Can_Ipw_ParseData(&CanIf_Mailbox, \
                                    &CanIf_PduInfo, \
                                    pReceivedDataBuffer, \
                                    Can_pControllerConfig, \
    ...
    /**
    *   @brief     Process to Map MB index to hardware object ID
    */
    static void Can_43_FLEXCAN_Ipw_HandleMapMbIndxToObjID
    (
        const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig
    )
    {
        ...
        for (u8HwObjRefIdx = 0U; u8HwObjRefIdx < Can_pControllerConfig->Can_u8HwObjectRefCount; u8HwObjRefIdx++)
        {
            ...
            if ((CAN_43_FLEXCAN_RX_NORMAL == Can_pHwObject->Can_eReceiveType) || \
                (CAN_43_FLEXCAN_TX_NORMAL == Can_pHwObject->Can_eReceiveType))
            {
                for (u8ObjIdx = 0U; u8ObjIdx < Can_pHwObject->Can_u8ObjectCount; u8ObjIdx++)
                {
                    Can_Ipw_au16MbIdxToObjIDMap[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObject->Can_pHwBufferIndex)[u8ObjIdx]] = Can_pHwObject->Can_HwObjectID;
                }
            }
            else if (CAN_43_FLEXCAN_RX_LEGACY_FIFO == Can_pHwObject->Can_eReceiveType)
            {
                Can_Ipw_au16MbIdxToObjIDMap[Can_pControllerConfig->Can_u8ControllerID][*(Can_pHwObject->Can_pHwBufferIndex)] = Can_pHwObject->Can_HwObjectID;
...
#if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
    /**
    *   @brief     Process Rx Legacy FIFO Dma
    */
    static void Can_43_FLEXCAN_Ipw_ProcessRxLegacyDma
    (
        const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
    ...
    )
    {
        ...
        u8HwObjectID = Can_Ipw_au16MbIdxToObjIDMap[Can_pControllerConfig->Can_u8ControllerID][CAN_43_FLEXCAN_MB_LEGACY_RXFIFO];
        if ((CAN_43_FLEXCAN_HWOBJ_UNMAPPED != u8HwObjectID) && (FALSE == Can_pHwObjectConfig[u8HwObjectID].Can_bHwObjectUsesPolling))
        {
...
#if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
    /**
    *   @brief     Process Rx Enhance FIFO Dma
    */
    static void Can_43_FLEXCAN_Ipw_ProcessRxEnhanceDma
    (
        const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
    ...
    )
    {
        ...
        if ((uint8)FLEXCAN_EVENT_DMA_COMPLETE == u8Event)
        {
            ...
            {
            #if (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON)
                Can_Ipw_u32MbTransferredIndex[Can_pControllerConfig->Can_u8ControllerID] = u32MbCnt;
            #endif /* (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) */
                Can_Ipw_ParseData(&CanIf_Mailbox, \
                                  &CanIf_PduInfo, \
    ...
    /**
    *   @brief     Start all receive object which using interrupt or Dma
    */
    static void Can_Ipw_StartAsyncReceiveObject(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig)
    {
        uint8 u8HwObjRefIdx = 0U;
        ...
        for (u8HwObjRefIdx = 0U; u8HwObjRefIdx < Can_pControllerConfig->Can_u8HwObjectRefCount; u8HwObjRefIdx++)
        {
            ...
            if (FALSE == Can_pHwObject->Can_bHwObjectUsesPolling)
            {
                ...
                {
                    case CAN_43_FLEXCAN_RX_NORMAL:
                    {
                        for (u8ObjIdx = 0U; u8ObjIdx < Can_pHwObject->Can_u8ObjectCount; u8ObjIdx++)
                        {
                            (void)FlexCAN_Ip_Receive(Can_pControllerConfig->Can_u8ControllerOffset, \
                                                     (Can_pHwObject->Can_pHwBufferIndex)[u8ObjIdx], \
                                                     NULL_PTR, \
                                                     Can_pHwObject->Can_bHwObjectUsesPolling \
                                                    );
                        }
                    ...
                    case CAN_43_FLEXCAN_RX_ENHANCED_FIFO : /* FallThrough Allowed */
                    case CAN_43_FLEXCAN_RX_LEGACY_FIFO:
                    {
                    #if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
...
Std_ReturnType Can_43_FLEXCAN_Ipw_Init(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig)
{
...
#if ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON) && (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON))
    Can_Ipw_u32MbTransferredIndex[Can_pControllerConfig->Can_u8ControllerID] = 0U;
#endif /* ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON) && (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)) */
#if (CAN_43_FLEXCAN_TS_EXTERNAL_TIMER_USED == STD_ON)
    ...
    eRetVal = (Std_ReturnType)FlexCAN_Ip_Init(Can_pControllerConfig->Can_u8ControllerOffset, \
    ...
    if ((Std_ReturnType)FLEXCAN_STATUS_SUCCESS == eRetVal)
    {
        ...
        /* Init all Rx objects */
        Can_Ipw_InitReceiveHwObject(Can_pControllerConfig);
    }

#if (CAN_43_FLEXCAN_MB_INTERRUPT_SUPPORT == STD_ON)
    /* Map MB index to hardware object ID */
    Can_43_FLEXCAN_Ipw_HandleMapMbIndxToObjID(Can_pControllerConfig);
#endif /* (CAN_43_FLEXCAN_MB_INTERRUPT_SUPPORT == STD_ON) */
...
*/
    ...
    )
    {
        ...
        eRetVal = (Flexcan_Ip_StatusType)FlexCAN_Ip_EnterFreezeMode(Can_pControllerConfig->Can_u8ControllerOffset);
        if (FLEXCAN_STATUS_SUCCESS == eRetVal)
        {
            ...
            eRetVal = (Flexcan_Ip_StatusType)FlexCAN_Ip_SetStopMode(Can_pControllerConfig->Can_u8ControllerOffset);
            if (FLEXCAN_STATUS_SUCCESS == eRetVal)
            {
...
static Std_ReturnType Can_43_FLEXCAN_Ipw_SetControlerErrorInit(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig)
{
    ...
    eRetVal = (Flexcan_Ip_StatusType)FlexCAN_Ip_SetStartMode(Can_pControllerConfig->Can_u8ControllerOffset);
...
Std_ReturnType Can_43_FLEXCAN_Ipw_SetControllerToStartMode(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig)
{
...
#endif
    eRetVal = (Flexcan_Ip_StatusType)FlexCAN_Ip_Init(Can_pControllerConfig->Can_u8ControllerOffset, \
                              &Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID], \
                              Can_pControllerConfig->HwChannelIpConfig->pFlexcanIpHwConfig
                             );
    ...
    #if (CAN_43_FLEXCAN_MB_INTERRUPT_SUPPORT == STD_ON)
        /* Start all receive object which using interrupt or Dma */
        Can_Ipw_StartAsyncReceiveObject(Can_pControllerConfig);
    #endif /* CAN_43_FLEXCAN_MB_INTERRUPT_SUPPORT == STD_ON */
...
Std_ReturnType Can_43_FLEXCAN_Ipw_SetControllerToStopMode(const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig)
{
    ...
    */
    ...
    if (FLEXCAN_STATUS_SUCCESS == (Flexcan_Ip_StatusType)FlexCAN_Ip_EnterFreezeMode(Can_pControllerConfig->Can_u8ControllerOffset))
    {
    if (TRUE == Can_Ipw_abIsInterruptEnabled[Can_pControllerConfig->Can_u8ControllerID])
    {
        (void)FlexCAN_Ip_DisableInterrupts(Can_pControllerConfig->Can_u8ControllerOffset);
    ...
    for (u8HwObjRefIdx = 0U; u8HwObjRefIdx < Can_pControllerConfig->Can_u8HwObjectRefCount; u8HwObjRefIdx++)
    {
            ...
            (CAN_43_FLEXCAN_TX_NORMAL == Can_pHwObject->Can_eReceiveType))
        {
            ...
            do
            {
                (void)FlexCAN_Ip_AbortTransfer(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObject->Can_pHwBufferIndex)[u8Idx]);
                u8Idx++;
            }while (u8Idx < Can_pHwObject->Can_u8ObjectCount);
        }
    #if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
        else if (CAN_43_FLEXCAN_RX_ENHANCED_FIFO == Can_pHwObject->Can_eReceiveType)
        {
            (void)FlexCAN_Ip_AbortTransfer(Can_pControllerConfig->Can_u8ControllerOffset, CAN_43_FLEXCAN_MB_ENHANCED_RXFIFO);
        }
    #endif
        else
        {
            (void)FlexCAN_Ip_AbortTransfer(Can_pControllerConfig->Can_u8ControllerOffset, *(Can_pHwObject->Can_pHwBufferIndex));
        }
    }
...
)
{
    ...
    if (CAN_43_FLEXCAN_TX_NORMAL == Can_pHwObjectConfig->Can_eReceiveType)
    {
        ...
        do
        {
            eRetVal = FlexCAN_Ip_GetTransferStatus(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]);
            if (FLEXCAN_STATUS_BUSY != eRetVal)
            {
                #if ((CAN_43_FLEXCAN_TX_POLLING_SUPPORT == STD_ON) || (FLEXCAN_IP_MB_INTERRUPT_SUPPORT == STD_ON))
                Can_Ipw_au16TxPduId[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]] = PduInfo->swPduHandle;
                #if (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON)
                Can_Ipw_abIsTxPduReady[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]] = TRUE;
                #endif /* (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) */
                #endif

                /* Start transfer data */
                eRetVal = Can_Ipw_TransferData(Can_pControllerConfig, Can_pHwObjectConfig, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx], PduInfo, &DataInfo);

                #if ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && ((CAN_43_FLEXCAN_TX_POLLING_SUPPORT == STD_ON) || (FLEXCAN_IP_MB_INTERRUPT_SUPPORT == STD_ON)))
                if (FLEXCAN_STATUS_SUCCESS != eRetVal)
                {
                    /* Revert to FALSE due to the MB was not transmitted successfully */
                    Can_Ipw_abIsTxPduReady[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]] = FALSE;
                }
                #endif /* ((CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) && ((CAN_43_FLEXCAN_TX_POLLING_SUPPORT == STD_ON) || (FLEXCAN_IP_MB_INTERRUPT_SUPPORT == STD_ON))) */
            }
            u8ObjIdx++;
...
static void Can_Ipw_InitReceiveHwObject(const Can_43_FLEXCAN_ControllerConfigType * Can_pController)
{
    ...
    for (u8HwObjRefIdx = 0U; u8HwObjRefIdx < Can_pController->Can_u8HwObjectRefCount; u8HwObjRefIdx++)
    {
        ...
        switch (Can_pHwObject->Can_eReceiveType)
        {
            case CAN_43_FLEXCAN_RX_NORMAL:
            {
                Can_Ipw_InitRxMsgBuffer(Can_pController, Can_pHwObject);
                break;
            }
            case CAN_43_FLEXCAN_RX_LEGACY_FIFO:
            {
                Can_Ipw_InitRxLegacyFifo(Can_pController, Can_pHwObject);
                break;
            }
        #if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
            case CAN_43_FLEXCAN_RX_ENHANCED_FIFO:
            {
                Can_Ipw_InitRxEnhancedFifo(Can_pController, Can_pHwObject);
                break;
            }
        #endif
            default:
    ...
    */
    ...
    )
    {
        ...
        {
            /* @violates @ref Can_43_FLEXCAN_Ipw_c_REF_3 MISRA 2012 Advisory Rule 12.3 */
            (void)FlexCAN_Ip_AbortTransfer(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8Idx]);
            u8Idx++;
    ...
    */
    ...
    )
    {
        ...
        do
        {
            if (FLEXCAN_MB_TX_BUSY == (Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]].state))
            {
                /* @violates @ref Can_Ipw_c_REF_3 MISRA 2012 Advisory Rule 12.3 */
                FlexCAN_Ip_MainFunctionWrite(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]);
                if (FLEXCAN_STATUS_SUCCESS == FlexCAN_Ip_GetTransferStatus(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]))
                {
                    CanIf_TxConfirmation(Can_Ipw_au16TxPduId[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]]);
                }
            }
            u8ObjIdx++;
        }while (u8ObjIdx < Can_pHwObjectConfig->Can_u8ObjectCount);
    ...
    */
    ...
    )
    {
        ...
        if (FALSE == (boolean)FlexCAN_Ip_GetStopMode(Can_pControllerConfig->Can_u8ControllerOffset))
        {
        if (CAN_43_FLEXCAN_RX_NORMAL == Can_pHwObjectConfig->Can_eReceiveType)
        {
            do
            {
                /* Reset MB's state mapped to current HwObject before start new reception */
                Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[(Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]].state = FLEXCAN_MB_IDLE;

                (void)FlexCAN_Ip_Receive(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx], &ReceivedDataBuffer, Can_pHwObjectConfig->Can_bHwObjectUsesPolling);
                FlexCAN_Ip_MainFunctionRead(Can_pControllerConfig->Can_u8ControllerOffset, (Can_pHwObjectConfig->Can_pHwBufferIndex)[u8ObjIdx]);
        ...
        else if (CAN_43_FLEXCAN_RX_LEGACY_FIFO == Can_pHwObjectConfig->Can_eReceiveType)
        {
        ...
        #if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
        else if (CAN_43_FLEXCAN_RX_ENHANCED_FIFO == Can_pHwObjectConfig->Can_eReceiveType)
        {
...
/**
*   @brief     Polling Wakeup events
*   @note      Only perform state transition according to ASR R23-11 requirement changes.
*/
void Can_43_FLEXCAN_Ipw_MainFunction_Wakeup
(
    const Can_43_FLEXCAN_ControllerConfigType * Can_pControllerConfig,
...
)
{
    ...
    {
        if (TRUE == FlexCAN_Ip_GetStopMode(Can_pControllerConfig->Can_u8ControllerOffset))
        {
    ...
    else if (CAN_CS_STOPPED == *Can_pControllerState)
    {
        ...
        /* Note: If hardware support wakeup then check sleep mode here
                 else ignore the check because transition from stop -> logical sleep is done without hardware change */
    }
    else /* CAN_CS_SLEEP */
    {
        /* Note: If hardware support wakeup then check stop mode here
                 else ignore the check because transition from logical sleep -> stop is done without hardware change */
    }
}
...
)
{
    ...
    if (CAN_CS_STARTED == *Can_pControllerState)
    {
        if (FALSE == (boolean)FlexCAN_Ip_GetStartMode(Can_pControllerConfig->Can_u8ControllerOffset))
        {
            *Can_pControllerState = CAN_CS_STOPPED;
            CanIf_ControllerModeIndication(Can_pControllerConfig->Can_u8AbstControllerID, CAN_CS_STOPPED);
        }
    ...
    {
        if (TRUE == (boolean)FlexCAN_Ip_GetStartMode(Can_pControllerConfig->Can_u8ControllerOffset))
        {
            *Can_pControllerState = CAN_CS_STARTED;
            CanIf_ControllerModeIndication(Can_pControllerConfig->Can_u8AbstControllerID, CAN_CS_STARTED);
        }
    ...
    */
    ...
    (
        ...
        uint8 u8MbIdxOrEvent,
        Can_43_FLEXCAN_MbType mbType
    )
    {
        switch (mbType)
        {
            case CAN_43_FLEXCAN_TX_NORMAL:
            {
                Can_43_FLEXCAN_Ipw_ProcessTxMesgBuffer(Can_pControllerConfig, Can_pConfig->Can_pHwObjectConfig, u8MbIdxOrEvent);
                break;
            }
            case CAN_43_FLEXCAN_RX_NORMAL:
            {
                Can_43_FLEXCAN_Ipw_ProcessRxMesgBuffer(Can_pControllerConfig, Can_pConfig->Can_pHwObjectConfig, u8MbIdxOrEvent);
                break;
            }
            case CAN_43_FLEXCAN_RX_LEGACY_FIFO:
            {
            #if (CAN_43_FLEXCAN_FEATURE_HAS_DMA_ENABLE == STD_ON)
                if (((uint8)FLEXCAN_EVENT_DMA_COMPLETE == u8MbIdxOrEvent) ||
                    ((uint8)FLEXCAN_EVENT_DMA_ERROR == u8MbIdxOrEvent))
                {
                    Can_43_FLEXCAN_Ipw_ProcessRxLegacyDma(Can_pControllerConfig, Can_pConfig->Can_pHwObjectConfig, u8MbIdxOrEvent);
                }
                else
            #endif
                {
                    Can_43_FLEXCAN_Ipw_ProcessRxLegacy(Can_pControllerConfig, Can_pConfig->Can_pHwObjectConfig, u8MbIdxOrEvent);
                }
                break;
            }
        #if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
            case CAN_43_FLEXCAN_RX_ENHANCED_FIFO:
            {
                ...
                if (((uint8)FLEXCAN_EVENT_DMA_COMPLETE == u8MbIdxOrEvent) ||
                    ((uint8)FLEXCAN_EVENT_DMA_ERROR == u8MbIdxOrEvent))
                {
                    Can_43_FLEXCAN_Ipw_ProcessRxEnhanceDma(Can_pControllerConfig, Can_pControllerConfig->Can_ppHwObject[0U], u8MbIdxOrEvent);
                }
                else
            #endif
                {
                    Can_43_FLEXCAN_Ipw_ProcessRxEnhance(Can_pControllerConfig, Can_pControllerConfig->Can_ppHwObject[0U], u8MbIdxOrEvent);
                }
                break;
            }
        #endif
...
void Can_43_FLEXCAN_Ipw_GetCurrentTime(Can_TimeStampType* timeStampPtr)
{
    ...
    timeStampPtr->seconds = (uint32)((u64TimerCurTime / (uint64)CAN_43_FLEXCAN_TS_STIMER_TICK_PER_SECOND) & (uint64)UINT32_MAX);
    /* Calculate nanosecond part */
    timeStampPtr->nanoseconds = (uint32)(((u64TimerCurTime % (uint64)CAN_43_FLEXCAN_TS_STIMER_TICK_PER_SECOND) * CAN_43_FLEXCAN_TS_STIMER_ACCURACY) / (uint64)1000U);
#endif
...
)
{
    ...
    do
    {
        if ((TxPduId == Can_Ipw_au16TxPduId[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[ObjIdx]])
        && (TRUE == Can_Ipw_abIsTxPduReady[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[ObjIdx]]))
        {
            Can_Ipw_GetTimestamp(timeStampPtr, Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[(Can_pHwObjectConfig->Can_pHwBufferIndex)[ObjIdx]].time_stamp);
            /* Release the lock for the Mb to avoid read again on this MB */
            Can_Ipw_abIsTxPduReady[Can_pControllerConfig->Can_u8ControllerID][(Can_pHwObjectConfig->Can_pHwBufferIndex)[ObjIdx]] = FALSE;
...
)
{
...
#if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
    if (CAN_43_FLEXCAN_RX_ENHANCED_FIFO == Can_pHwObjectConfig->Can_eReceiveType)
    {
    #if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
        if (FLEXCAN_RXFIFO_USING_DMA == Can_pControllerConfig->HwChannelIpConfig->pFlexcanIpHwConfig->transfer_type)
        {
            Can_Ipw_GetTimestamp(timeStampPtr, Can_pControllerConfig->pDmaDstAddr[Can_Ipw_u32MbTransferredIndex[Can_pControllerConfig->Can_u8ControllerID]].time_stamp);
        }
        else
        {
    #endif /* (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON) */
            Can_Ipw_GetTimestamp(timeStampPtr, Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].enhancedFifoOutput.pMBmessage->time_stamp);
    #if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
        }
    #endif /* (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON) */
    }
    else
    {
        ...
        #endif /* (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON) */
                /* For legacy fifo, just 16 upper-bits captured */
                Can_Ipw_GetTimestamp(timeStampPtr, (Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[*(Can_pHwObjectConfig->Can_pHwBufferIndex)].pMBmessage->time_stamp) << 16U);
        #if (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON)
            }
        #endif /* (FLEXCAN_IP_FEATURE_HAS_DMA_ENABLE == STD_ON) */
        }
        else
        {
            do
            {
                Can_Ipw_GetTimestamp(timeStampPtr, Can_Ipw_apxStatus[Can_pControllerConfig->Can_u8ControllerID].mbs[(Can_pHwObjectConfig->Can_pHwBufferIndex)[ObjIdx]].pMBmessage->time_stamp);
                ObjIdx++;
            } while (ObjIdx < Can_pHwObjectConfig->Can_u8ObjectCount);
        }
#if (CAN_43_FLEXCAN_ENHANCED_FIFO_ENABLED == STD_ON)
