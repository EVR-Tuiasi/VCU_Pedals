...
#define SDADC_IP_AR_RELEASE_MINOR_VERSION_TYPES       9
#define SDADC_IP_AR_RELEASE_REVISION_VERSION_TYPES    0
#define SDADC_IP_SW_MAJOR_VERSION_TYPES               7
#define SDADC_IP_SW_MINOR_VERSION_TYPES               0
#define SDADC_IP_SW_PATCH_VERSION_TYPES               1
 ...
 */
typedef void Sdadc_Ip_WdgNotificationType(const uint16 ChanIdx, const uint32 Flags);
