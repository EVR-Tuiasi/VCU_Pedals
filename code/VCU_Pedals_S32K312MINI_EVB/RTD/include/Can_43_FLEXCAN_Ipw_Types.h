...
/**
*   @file    Can_43_FLEXCAN_Ipw_Types.h
*   @version 7.0.1
*
*   @brief   AUTOSAR Can_43_FLEXCAN - module interface
*   @details This file contains the type definitions for the driver - can include different IPV models.
*
...
#define CAN_43_FLEXCAN_IPW_TYPES_AR_RELEASE_MINOR_VERSION_H     9
#define CAN_43_FLEXCAN_IPW_TYPES_AR_RELEASE_REVISION_VERSION_H  0
#define CAN_43_FLEXCAN_IPW_TYPES_SW_MAJOR_VERSION_H             7
#define CAN_43_FLEXCAN_IPW_TYPES_SW_MINOR_VERSION_H             0
#define CAN_43_FLEXCAN_IPW_TYPES_SW_PATCH_VERSION_H             1
