...
#define CAN_43_FLEXCAN_AR_RELEASE_MINOR_VERSION    9
#define CAN_43_FLEXCAN_AR_RELEASE_REVISION_VERSION 0
#define CAN_43_FLEXCAN_SW_MAJOR_VERSION            7
#define CAN_43_FLEXCAN_SW_MINOR_VERSION            0
#define CAN_43_FLEXCAN_SW_PATCH_VERSION            1
/**@}*/
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
typedef struct
{
    ...
    const uint32 Can_u32PartitionId;
...
/* Calling the external Configuration symbols defined by Can_43_FLEXCAN_Cfg.h */
#ifdef CAN_43_FLEXCAN_CONFIG_EXT
