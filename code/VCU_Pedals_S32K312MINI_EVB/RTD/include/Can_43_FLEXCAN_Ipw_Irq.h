...
#define CAN_43_FLEXCAN_IPW_IRQ_AR_RELEASE_MINOR_VERSION    9
#define CAN_43_FLEXCAN_IPW_IRQ_AR_RELEASE_REVISION_VERSION 0
#define CAN_43_FLEXCAN_IPW_IRQ_SW_MAJOR_VERSION            7
#define CAN_43_FLEXCAN_IPW_IRQ_SW_MINOR_VERSION            0
#define CAN_43_FLEXCAN_IPW_IRQ_SW_PATCH_VERSION            1
