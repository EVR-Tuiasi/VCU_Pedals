...
#define BCTU_IP_AR_RELEASE_MINOR_VERSION       9
#define BCTU_IP_AR_RELEASE_REVISION_VERSION    0
#define BCTU_IP_SW_MAJOR_VERSION               7
#define BCTU_IP_SW_MINOR_VERSION               0
#define BCTU_IP_SW_PATCH_VERSION               1
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
/* MCR IEN 2 and 3 MASK definition for instances without them */
#if !defined (BCTU_MCR_IEN2_MASK)
  #define BCTU_MCR_IEN2_MASK             ((uint32)0U)
#endif /*  BCTU_MCR_IEN2_MASK */

#if !defined (BCTU_MCR_IEN3_MASK)
  #define BCTU_MCR_IEN3_MASK             ((uint32)0U)
#endif /*  BCTU_MCR_IEN3_MASK */
