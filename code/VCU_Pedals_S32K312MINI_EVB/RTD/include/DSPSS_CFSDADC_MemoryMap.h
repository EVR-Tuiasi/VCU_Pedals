...
#define DSPSS_AR_RELEASE_MINOR_VERSION_CFSADC_MEMORYMAP       9
#define DSPSS_AR_RELEASE_REVISION_VERSION_CFSADC_MEMORYMAP    0
#define DSPSS_SW_MAJOR_VERSION_CFSADC_MEMORYMAP               7
#define DSPSS_SW_MINOR_VERSION_CFSADC_MEMORYMAP               0
#define DSPSS_SW_PATCH_VERSION_CFSADC_MEMORYMAP               1
