...
*   @details This file contains the type definitions for the driver
*
...
#define CAN_FLEXCAN_TYPES_AR_RELEASE_MINOR_VERSION_H     9
#define CAN_FLEXCAN_TYPES_AR_RELEASE_REVISION_VERSION_H  0
#define CAN_FLEXCAN_TYPES_SW_MAJOR_VERSION_H             7
...
*/
    ...
    /*! @brief Service ID of Can_43_FLEXCAN_MainFunction_Wakeup */
    ...
    /*! @brief Service ID of Can_43_FLEXCAN_ListenOnlyMode */
    #define CAN_43_FLEXCAN_SID_LISTEN_ONLY_MODE                    ((uint8)0x32U)
#endif
#if (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON)
    #if (CAN_43_FLEXCAN_TS_EXTERNAL_TIMER_USED == STD_ON)
        /*! @brief Service ID of Can_43_FLEXCAN_SetCurrentTime */
        #define CAN_43_FLEXCAN_SID_SET_CURRENT_TIME                ((uint8)0x17U)
    #endif
    /*! @brief Service ID of Can_43_FLEXCAN_GetCurrentTime */
    #define CAN_43_FLEXCAN_SID_GET_CURRENT_TIME                    ((uint8)0x32U)
    /*! @brief Service ID of Can_43_FLEXCAN_EnableEgressTimeStamp */
    #define CAN_43_FLEXCAN_SID_ENABLE_EGRESS_TIMESTAMP             ((uint8)0x33U)
    /*! @brief Service ID of Can_43_FLEXCAN_GetEgressTimeStamp */
    #define CAN_43_FLEXCAN_SID_GET_EGRESS_TIMESTAMP                ((uint8)0x34U)
    /*! @brief Service ID of Can_43_FLEXCAN_GetIngressTimeStamp */
    #define CAN_43_FLEXCAN_SID_GET_INGRESS_TIMESTAMP               ((uint8)0x35U)
#endif /* (CAN_43_FLEXCAN_TIMESTAMP_ENABLE == STD_ON) */


/*! @brief Specifies CAN FD flag mask */
#define CAN_43_FLEXCAN_FD_FRAME_U32                                ((uint32)0x40000000U)
/*! @brief Specifies Extended ID flag mask */
...
typedef enum
{
    CAN_43_FLEXCAN_RECEIVE = 0,    /**< @brief Specifies the HardwareObject is used as Receive */
    CAN_43_FLEXCAN_TRANSMIT        /**< @brief Specifies the HardwareObject is used as Transmit */
}Can_43_FLEXCAN_HwObjectHandleType;

/** @brief Can Id Message */
typedef enum
{
    CAN_43_FLEXCAN_STANDARD = 0,   /**< @brief All the CANIDs are of type standard only (11bit). */
    CAN_43_FLEXCAN_EXTENDED,       /**< @brief All the CANIDs are of type extended only (29 bit) */
    CAN_43_FLEXCAN_MIXED           /**< @brief All the CANIDs are of type extended only (29 bit) */
}Can_43_FLEXCAN_IdMessageType;

/** @brief Message Buffer Type: TX, RX, RX FIFO */
typedef enum
{
    CAN_43_FLEXCAN_RX_NORMAL = 0,            /**< @brief Specifies the HardwareObject is used as Normal Receive Object */
    CAN_43_FLEXCAN_RX_LEGACY_FIFO,           /**< @brief Specifies the HardwareObject is used as Legacy FIFO Receive Object */
    CAN_43_FLEXCAN_RX_ENHANCED_FIFO,         /**< @brief Specifies the HardwareObject is used as Enhanced FIFO Receive Object */
    CAN_43_FLEXCAN_TX_NORMAL                 /**< @brief Specifies the HardwareObject is used as Normal Transmit Object */
}Can_43_FLEXCAN_MbType;

/** @brief Legacy FIFO ID Acceptance Mode */
typedef enum
{
    CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_A = 0U,  /**< @brief One full ID (standard and extended) per ID filter table element. */
    CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_B = 1U,  /**< @brief Two full standard IDs or two partial 14-bit (standard and extended) IDs per ID filter table element. */
    CAN_43_FLEXCAN_LEGACY_FIFO_FORMAT_C = 2U   /**< @brief Four partial 8-bit standard IDs per ID filter table element. */
...
typedef struct
{
    ...
    const uint8 * Can_pHwBufferIndex;
...
typedef struct
{
    ...
    /** @brief Wakeup uses Polling */
    const boolean Can_bWakeupUsesPolling;
    ...
    const Can_43_FLEXCAN_NotifyType Can_pEnhanceFiFoOvfNotif;
