...
#define ADC_AR_RELEASE_MINOR_VERSION            9
#define ADC_AR_RELEASE_REVISION_VERSION         0
#define ADC_SW_MAJOR_VERSION                    7
...
#define ADC_E_DMA_FIFO_TRANSFER                      ((uint8)0x31U)
#endif /* ADC_CTU_DMA_SUPPORTED */

/**
* @brief   Wrong trigger source to be used in loop mode
* */
#define ADC_E_INVALID_PARAM                          ((uint8)0x32U)
...
/**
* @brief API service ID for Adc_ApplyCalibration function
* */
#define ADC_APPLY_CALIBRATION_ID                     (0x4CU)
#endif /* (ADC_APPLY_CALIBRATION == STD_ON) */

#if (ADC_USER_GAIN_OFFSET == STD_ON)
/**
* @brief API service ID for Adc_SetUserGainAndOffset function
* */
#define ADC_SET_USER_GAIN_AND_OFFSET_ID              (0x4DU)
...
*
* @note           For platforms with both SDADC and ADC_SAR IPs present:
*                 Values put in DataBufferPtr will be of type uint16 if the selected
*                 group is using ADC_SAR IP and if the group is using SDADC IP the
*                 values put in DataBufferPtr will be of type sint16.
*
...
* @note           For platforms with both SDADC and ADC_SAR IPs present:
*                 Values put in DataBufferPtr will be of type uint16 if the selected
*                 Unit is ADC_SAR and if the Unit is SDADC the values put in
*                 DataBufferPtr will be of type sint16.
*
 ...
 *
 * @param[in]  Group                Group logical ID or group symbolic name
...
* @details        This function applies calibration to the uncalibrated converted data acquired by DMA or Sdadc_Ip_GetRawConvDataFifo function.
*                 In the case uncalibrated converted data acquired by DMA, this function should be called in the DMA callback.
*                 NOTE: this function is only used for SDADC hardware units.
*
* @param[in]      Unit                Adc unit used. Recommended to use generated define for Adc Logical Unit Id.
...
*
* @return         Std_ReturnType.     Status of the apply calibration result.
*                 E_OK:               Calibration applied successfully.
*                 E_NOT_OK:           Invalid parameter given.
*
...
#if (ADC_USER_GAIN_OFFSET == STD_ON)
/**
* @brief          Sets user gain and offset for an ADC unit.
* @details        This function sets user gain and offset for an ADC unit.
*
* @param[in]      Unit                Adc unit used (symbolic name).
* @param[in]      Gain                Gain value.
* @param[in]      Offset              Offset value.
*
* @return         Std_ReturnType.     Status of the set user gain and offset result.
*                 E_OK:               Values applied successfully.
*                 E_NOT_OK:           Invalid parameter given.
*
...
*
* @param[in]    AdcUnit      Adc HW unit. Recommended to use generated define for Adc Logical Unit Id.
* @param[out]   Result       Adc result structure.
*
* @return       void
*
...
*
* @param[in] Unit                 Adc unit used. Recommended to use generated define for Adc Logical Unit Id.
* @param[in] TempSenseAdcConvData Data measured on the ADC internal channel for TempSense.
