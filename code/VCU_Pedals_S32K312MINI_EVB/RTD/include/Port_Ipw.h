...
#define PORT_AR_RELEASE_MINOR_VERSION_IPW_H     9
#define PORT_AR_RELEASE_REVISION_VERSION_IPW_H  0
#define PORT_SW_MAJOR_VERSION_IPW_H             7
...
/* @brief Number of pins per block on the platform */
#define PORT_NUM_PIN_PER_BLOCK_U8                        ((uint16)16)
