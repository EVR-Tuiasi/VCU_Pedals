...
#define ADC_IPW_AR_RELEASE_MINOR_VERSION_TYPES        9
#define ADC_IPW_AR_RELEASE_REVISION_VERSION_TYPES     0
#define ADC_IPW_SW_MAJOR_VERSION_TYPES                7
#define ADC_IPW_SW_MINOR_VERSION_TYPES                0
#define ADC_IPW_SW_PATCH_VERSION_TYPES                1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
/** @implements     Adc_UserGainType_uint */
typedef uint32 Adc_UserGainType;      /**< @brief User Gain type */

/** @implements     Adc_UserOffsetType_uint */
typedef uint32 Adc_UserOffsetType;      /**< @brief User Offset type */
...
typedef enum
{
    ADC_CONV_TYPE_NORMAL   = ADC_CDR_RESULT_NORMAL_TRIGGER,     /**< @brief Normal conversion mode */
    ADC_CONV_TYPE_INJECTED = ADC_CDR_RESULT_INJECTED_TRIGGER,   /**< @brief Injected conversion mode */
} Adc_GroupConvType;

#if (ADC_SET_HW_UNIT_POWER_MODE_API==STD_ON) || \
    ((ADC_SAR_IP_HAS_TEMPSENSE_CHN == 1U) && (ADC_ENABLE_TEMPSENSE_API == STD_ON))
/**
...
#if ((ADC_IPW_CTU_AVAILABLE == STD_ON) && \
     (ADC_CTU_HW_TRIGGER_OPTIMIZATION == STD_OFF))
#define ADC_IPW_CTU_IP_COMMAND_LIST_COUNT                       (CTU_IP_COMMAND_LIST_COUNT)
#endif /* (ADC_IPW_CTU_AVAILABLE == STD_ON) && ...) */
#if (ADC_ENABLE_CTU_CONTROL_MODE_API == STD_ON)
/**
* @brief           Number of CTU/BCTU Instances
*/
#define ADC_IPW_NUM_CTU_INSTANCES                               (BCTU_IP_INSTANCE_COUNT)
/**
...
*/
#define ADC_IPW_NUM_CTU_LIST_ELEMS(CtuUnit)                     (BCTU_IP_LISTCHR_COUNT(Adc_apxCfgPtr[UserId]->AdcIpwConfigPtr->Mapping.CtuLogToPhyId[CtuUnit]) * 2u) /* Each LISTCHR reg contains 2 list elements */
