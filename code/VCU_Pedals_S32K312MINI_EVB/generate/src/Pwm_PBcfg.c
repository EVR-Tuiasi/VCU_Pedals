...
#define PWM_PB_CFG_AR_RELEASE_MINOR_VERSION_C        9
#define PWM_PB_CFG_AR_RELEASE_REVISION_VERSION_C     0
#define PWM_PB_CFG_SW_MAJOR_VERSION_C                7
...
*
*/
static const Pwm_ChannelConfigType Pwm_Channels_PB[PWM_PB_CFG_CHANNELS_COUNT] =
{
    /* PwmChannel_0 */
    {
        /** @brief  Channel Id */
        ...
        /** @brief  Ip channel configuration */
        {
            ...
            (const void *)(&Emios_Pwm_Ip_I1_Ch12),
            ...
            (Pwm_IpwInstanceType)EMIOS_PWM_IP_I1_CH12_CFG,
    ...
    /* PwmChannel_1 */
    {
        ...
        /** @brief  Ip channel configuration */
        {
            ...
            PWM_CHANNEL_EMIOS,
            /** @brief  Pointer to the Emios ip Configuration */
            (const void *)(&Emios_Pwm_Ip_I1_Ch13),
        #if (defined(PWM_FTM_USED) && (PWM_FTM_USED == STD_ON))
            /** @brief  Pointer to the Ftm ip Channel Configuration */
            NULL_PTR,
        #endif
        ...
        #endif
            /** @brief  Hardware Channel Instance ID */
            (Pwm_IpwInstanceType)EMIOS_PWM_IP_I1_CH13_CFG,
            /** @brief The duty cycle of this channel */
            0U
        },
        /** @brief  The state of the channel output in idle mode */
    ...
    /* PwmChannel_2 */
    {
        ...
        /** @brief  Ip channel configuration */
        {
            ...
            PWM_CHANNEL_EMIOS,
            /** @brief  Pointer to the Emios ip Configuration */
            (const void *)(&Emios_Pwm_Ip_I1_Ch14),
        #if (defined(PWM_FTM_USED) && (PWM_FTM_USED == STD_ON))
            /** @brief  Pointer to the Ftm ip Channel Configuration */
            NULL_PTR,
        #endif
        ...
        #endif
            /** @brief  Hardware Channel Instance ID */
            (Pwm_IpwInstanceType)EMIOS_PWM_IP_I1_CH14_CFG,
            /** @brief The duty cycle of this channel */
            0U
        },
        /** @brief  The state of the channel output in idle mode */
