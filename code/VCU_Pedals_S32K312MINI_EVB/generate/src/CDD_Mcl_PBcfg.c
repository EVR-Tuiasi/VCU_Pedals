...
#define CDD_MCL_PBCFG_AR_RELEASE_MINOR_VERSION_C      9
#define CDD_MCL_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define CDD_MCL_PBCFG_SW_MAJOR_VERSION_C              7
...
* @details This structure should contain data about the EMIOS common
*          part configurated using Mcl driver
