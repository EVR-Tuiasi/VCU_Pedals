...
#define GPT_AR_RELEASE_MINOR_VERSION_PBCFG_C       9
#define GPT_AR_RELEASE_REVISION_VERSION_PBCFG_C    0
#define GPT_SW_MAJOR_VERSION_PBCFG_C               7
...
*/
extern void Can_Timer_Timeout(void);
/*==================================================================================================
*                                       GLOBAL CONSTANTS
==================================================================================================*/
...
static const Gpt_ChannelConfigType Gpt_InitChannelPB[GPT_CONF_CHANNELS_PB] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        ...
        &Can_Timer_Timeout, /* Channel notification */
