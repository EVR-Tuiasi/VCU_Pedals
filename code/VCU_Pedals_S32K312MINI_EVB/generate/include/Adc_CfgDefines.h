...
#define ADC_AR_RELEASE_MINOR_VERSION_CFGDEFINES       9
#define ADC_AR_RELEASE_REVISION_VERSION_CFGDEFINES    0
#define ADC_SW_MAJOR_VERSION_CFGDEFINES               7
...
/* Check if Adc_CfgDefines.h file and Std_Types.h file are of the same Autosar version */
#if ((ADC_AR_RELEASE_MAJOR_VERSION_CFGDEFINES != STD_AR_RELEASE_MAJOR_VERSION) || \
     (ADC_AR_RELEASE_MINOR_VERSION_CFGDEFINES != STD_AR_RELEASE_MINOR_VERSION)    \
    )
    #error "AutoSar Version Numbers of Adc_CfgDefines.h and Std_Types.h are different"
#endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
*/
#define ADC_AVERAGING_FUNCTIONALITY_SUPPORT (STD_ON)
...
/**
* @brief          Add/remove ((STD_ON)/(STD_OFF)) the service Adc_SetUserGainAndOffset() from the code.
*/
#define ADC_USER_GAIN_OFFSET                      (STD_OFF)
/**
...
*/
#define ADC_UNIT_0_NORMAL_ISR_USED
#define ADC_UNIT_0_INJECTED_ISR_USED
#define ADC_UNIT_1_NORMAL_ISR_USED
#define ADC_UNIT_1_INJECTED_ISR_USED
