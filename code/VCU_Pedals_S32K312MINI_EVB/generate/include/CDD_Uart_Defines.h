...
#define UART_DEFINES_AR_RELEASE_MINOR_VERSION_CFG      9
#define UART_DEFINES_AR_RELEASE_REVISION_VERSION_CFG   0
#define UART_DEFINES_SW_MAJOR_VERSION_CFG              7
...
#if (STD_ON == UART_CALLBACK_DECLARED)
/* @brief Number of available hardware instances */
#define UART_NUMBER_OF_INSTANCES             (16U)

/* @brief UART Hardware instances mapping initialize value */
#define UART_HW_CHANNELS_MAPPING_FOR_INIT       {255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U}
#endif /* (STD_ON == UART_CALLBACK_DECLARED) */
