...
#define EMIOS_PWM_IP_CFG_SW_MAJOR_VERSION             7
...
==================================================================================================*/
    ...
    /* Check if header file and Emios_Pwm_Ip_PBcfg header file are of the same vendor */
    ...
    /* Check if header file and Emios_Pwm_Ip_PBcfg header file are of the same AUTOSAR version */
    ...
    /* Check if header file and Emios_Pwm_Ip_PBcfg header file are of the same software version */
...
#define EMIOS_PWM_IP_COUNTER_BUS_BCD               (248U)
...
{ \
    ...
    {255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 0U, 1U, 2U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 3U} \
}

/** @brief    Calculate the supported eMios channels */
#define EMIOS_PWM_IP_NUM_OF_CHANNELS_USED_U8       ((uint8)4U)
