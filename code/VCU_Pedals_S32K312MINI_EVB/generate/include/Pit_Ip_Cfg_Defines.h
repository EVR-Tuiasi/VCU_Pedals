...
==================================================================================================*/
#define PIT_IP_CFG_DEFINES_VENDOR_ID_CFG                    43
#define PIT_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION_CFG     4
#define PIT_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_CFG     9
#define PIT_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION_CFG  0
#define PIT_IP_CFG_DEFINES_SW_MAJOR_VERSION_CFG             7
#define PIT_IP_CFG_DEFINES_SW_MINOR_VERSION_CFG             0
#define PIT_IP_CFG_DEFINES_SW_PATCH_VERSION_CFG             1
...
/* Check if header file and Std_Types.h file are of the same Autosar version */
    ...
    #if ((PIT_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION_CFG != STD_AR_RELEASE_MAJOR_VERSION) || \
         (PIT_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_CFG != STD_AR_RELEASE_MINOR_VERSION))
...
#define PIT_IP_RTI_INSTANCE_NUM (PIT_0_IP_INSTANCE_NUMBER)
/**
* @brief This defines
*
*/
