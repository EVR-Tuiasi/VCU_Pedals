...
#define PORT_SW_MAJOR_VERSION_VS_0_PBCFG_C                2
...
*                                      FILE VERSION CHECKS
=================================================================================================*/
/* Check if the files Port_VS_0_PBcfg.c and Port.h are of the same vendor */
#if (PORT_VENDOR_ID_VS_0_PBCFG_C != PORT_VENDOR_ID)
    #error "Port_VS_0_PBcfg.c and Port.h have different vendor ids"
#endif
/* Check if the files Port_VS_0_PBcfg.c and Port.h are of the same Autosar version */
...
#endif
/* Check if the files Port_VS_0_PBcfg.c and Port.h are of the same software version */
...
*/
#define PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8         (0U)
 ...
 */
static const Port_UnUsedPinConfigType Port_UnUsedPin_VS_0 =
{
...
*/
static const Port_PinConfigType Port_aPinConfigDefault_VS_0[PORT_MAX_CONFIGURED_PADS_U16]=
{
...
static const Port_Ci_Port_Ip_DigitalFilterConfigType Port_aDigitalFilter_VS_0[PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8]=
{
};
#endif /* (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8) */
...
const Port_ConfigType Port_Config =
{
    ...
    PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8,
#if (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8)
