...
#define ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_C     7
#define ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_C  0
#define ADC_SW_MAJOR_VERSION_VS_0_PBCFG_C             2
...
#if (ADC_VENDOR_ID_VS_0_PBCFG_C != ADC_VENDOR_ID_VS_0_PBCFG)
...
#if ((ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG_C != ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG) || \
     (ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_C != ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG) || \
     (ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_C != ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG) \
    )
...
#if ((ADC_SW_MAJOR_VERSION_VS_0_PBCFG_C != ADC_SW_MAJOR_VERSION_VS_0_PBCFG) || \
     (ADC_SW_MINOR_VERSION_VS_0_PBCFG_C != ADC_SW_MINOR_VERSION_VS_0_PBCFG) || \
     (ADC_SW_PATCH_VERSION_VS_0_PBCFG_C != ADC_SW_PATCH_VERSION_VS_0_PBCFG) \
    )
...
#if (ADC_VENDOR_ID_VS_0_PBCFG_C != ADC_IPW_VENDOR_ID_VS_0_PBCFG)
...
#if ((ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG_C != ADC_IPW_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG) || \
     (ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_C != ADC_IPW_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG) || \
     (ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_C != ADC_IPW_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG) \
    )
...
#if ((ADC_SW_MAJOR_VERSION_VS_0_PBCFG_C != ADC_IPW_SW_MAJOR_VERSION_VS_0_PBCFG) || \
     (ADC_SW_MINOR_VERSION_VS_0_PBCFG_C != ADC_IPW_SW_MINOR_VERSION_VS_0_PBCFG) || \
     (ADC_SW_PATCH_VERSION_VS_0_PBCFG_C != ADC_IPW_SW_PATCH_VERSION_VS_0_PBCFG) \
    )
...
/**
* @brief          Group Assignments on ADC1 _VS_0.
*
*/
...
static const Adc_GroupConfigurationType Adc_GroupsCfg_VS_0[] =
{
    /**< @brief Group0 -- Logical Unit Id 0 -- Hardware Unit ADC1 */
    {
        ...
        Adc_Group0_Assignment_1_VS_0, /* AssignmentPtr */
    ...
    /**< @brief Group1 -- Logical Unit Id 1 -- Hardware Unit ADC0 */
    {
        /**< @brief Index of group */
        1U, /* GroupId */
        /**< @brief ADC Logical Unit Id that the group belongs to */
...
{
    &AdcIpwCfg_VS_0, /* AdcIpwConfigPtr */
    /** @brief Group configurations */
    Adc_GroupsCfg_VS_0, /* GroupsPtr */
    ADC_GROUPS_VS_0, /* GroupCount */
    /**< @brief Array for mapping the groups */
    Adc_au16GroupIdToIndexMap_VS_0, /* GroupIdToIndexMapPtr */
