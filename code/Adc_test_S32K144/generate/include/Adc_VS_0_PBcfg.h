...
#define ADC_VENDOR_ID_VS_0_PBCFG                      43
#define ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG       4
#define ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG       7
#define ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG    0
#define ADC_SW_MAJOR_VERSION_VS_0_PBCFG               2
#define ADC_SW_MINOR_VERSION_VS_0_PBCFG               0
#define ADC_SW_PATCH_VERSION_VS_0_PBCFG               0
...
#if (ADC_VENDOR_ID_VS_0_PBCFG != ADC_VENDOR_ID_TYPES)
...
#if ((ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_MAJOR_VERSION_TYPES) || \
     (ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_MINOR_VERSION_TYPES) || \
     (ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_REVISION_VERSION_TYPES) \
    )
...
#if ((ADC_SW_MAJOR_VERSION_VS_0_PBCFG != ADC_SW_MAJOR_VERSION_TYPES) || \
     (ADC_SW_MINOR_VERSION_VS_0_PBCFG != ADC_SW_MINOR_VERSION_TYPES) || \
     (ADC_SW_PATCH_VERSION_VS_0_PBCFG != ADC_SW_PATCH_VERSION_TYPES) \
    )
