...
==================================================================================================*/
#define ADC_IP_VENDOR_ID_VS_0_PBCFG                     43
#define ADC_IP_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG      4
#define ADC_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG      7
#define ADC_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG   0
#define ADC_IP_SW_MAJOR_VERSION_VS_0_PBCFG              2
#define ADC_IP_SW_MINOR_VERSION_VS_0_PBCFG              0
#define ADC_IP_SW_PATCH_VERSION_VS_0_PBCFG              0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Adc_Ip_VS_0_PBcfg.h file and Adc_Ip_Types.h file are of the same vendor */
#if (ADC_IP_VENDOR_ID_VS_0_PBCFG != ADC_IP_VENDOR_ID_TYPES)
...
#if ((ADC_IP_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG != ADC_IP_AR_RELEASE_MAJOR_VERSION_TYPES) || \
     (ADC_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG != ADC_IP_AR_RELEASE_MINOR_VERSION_TYPES) || \
     (ADC_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG != ADC_IP_AR_RELEASE_REVISION_VERSION_TYPES) \
    )
...
#if ((ADC_IP_SW_MAJOR_VERSION_VS_0_PBCFG != ADC_IP_SW_MAJOR_VERSION_TYPES) || \
     (ADC_IP_SW_MINOR_VERSION_VS_0_PBCFG != ADC_IP_SW_MINOR_VERSION_TYPES) || \
     (ADC_IP_SW_PATCH_VERSION_VS_0_PBCFG != ADC_IP_SW_PATCH_VERSION_TYPES) \
    )
